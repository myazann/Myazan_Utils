...
dt_tuning_df = pd.DataFrame(columns = [
                                      "class_weight","max_leaf_nodes",
                                      "min_samples_leaf","f1_train","f1_val",
...
rf_tuning_df = pd.DataFrame(columns = [ 
                                        "n_estimators",
                                        "class_weight",
                                        "max_leaf_nodes",
                                        "min_samples_leaf",
...
results_frame_XG = pd.DataFrame(columns=  [
...
for i in range(2000):
    ...
    tuned_tree = XGBClassifier(
                                objective = "binary:logistic", booster = "gbtree", random_state = 0,
